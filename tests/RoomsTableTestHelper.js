...
const RoomsTableTestHelper = {
  async addRoom({
    ...
    const query = {
      text: `INSERT INTO rooms (id, owner_id, room_number, type, price, status, facilities)
                    VALUES ($1, $2, $3, $4, $5, $6, $7)`,
      values: [id, owner_id, room_number, type, price, status, facilities ? JSON.stringify(facilities) : null]
    }
