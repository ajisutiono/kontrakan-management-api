...
describe('UserRepository abstract methods', () => {
  ...
  it('verifyAvailabilityEmail should throw METHOD_NOT_IMPLEMENTED', async () => {
    await expect(
      repository.verifyAvailabilityEmail('test@example.com'),
  ...
  it('getUserByEmail should throw METHOD_NOT_IMPLEMENTED', async () => {
    await expect(
